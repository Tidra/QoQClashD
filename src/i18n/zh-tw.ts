...
const zhTW: Partial<LANG_MESSAGE> = {
  ...
  panelPasswordSave: '登入',
  panelPasswordSaved: '面板密碼已儲存',
  goToDashboard: '進入控制面板',
  ...
  subscriptionDescription: '集中管理代理訂閱來源，支援快速新增、編輯、啟用與更新。',
  ...
  nodePoolRemove: '移除池',
  nodePoolAdd: '新增節點池',
  nodePoolEditTitle: '編輯節點池',
  nodePoolAddTitle: '新增節點池',
  nodePoolEmpty: '還沒有節點池，建立一個開始管理節點。',
  nodePoolEmptyDesc: '節點池幫助你整理、去重並測試節點，然後產生 selector 群組。',
  nodeEditTitle: '編輯節點',
  nodeAddTitle: '新增節點',
  nodeName: '名稱',
  ...
  tunDevice: '裝置名稱',
  tunConfig: 'TUN 設定',
  dualModeConfig: '雙模式設定',
  dualModeForm: '表單',
  dualModeYaml: 'YAML',
  dualModeSyncToForm: '同步到表單',
  ...
  secondaryPathPlaceholder: '可選，如 /sub',
  ...
  loadBalance: '負載均衡',
  label: '標籤',
  backendLabelPlaceholder: '例如：家裡電腦',
  optional: '可選',
