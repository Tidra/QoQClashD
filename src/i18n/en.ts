const en = {
  ...
  subscriptionDescription: 'Manage your proxy subscriptions in one place with quick add, edit, enable, and refresh actions.',
  ...
  nodePoolEmptyDesc: 'Proxy groups map directly to Clash proxy-groups, with all member editing rules preserved.',
  proxyGroupEditor: 'Proxy group editor',
  proxyGroupEditorDescription: 'Edit real Clash proxy-groups. Draft changes are saved in the dashboard database first, then applied to the kernel manually.',
  ...
  proxyGroupEditorNoGroups: 'No proxy groups in the current configuration. Add one to start editing.',
