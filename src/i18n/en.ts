const en = {
  ...
  panelPasswordCurrent: 'Current password',
  panelPasswordNew: 'New password',
  ...
  panelLoginFailed: 'Could not reach the panel server. Please try again.',
  logout: 'Log out',
  refresh: 'Refresh',
  edit: 'Edit',
  add: 'Add',
  ...
  subscriptionApplyToKernel: 'Apply to kernel after update',
  subscriptionApplyToKernelSummary: 'Restart the kernel to apply new nodes',
  ...
  nodePoolEmpty:
    'No nodes yet. Click “New node” to add one, or open “Subscriptions” to import a subscription link.',
  ...
  kernelApiPortLabel: 'Clash API port',
  kernelApiPortSummary:
    'Editable · address the kernel REST API listens on; the panel reaches it through /api/mihomo',
  kernelSharedSecretLabel: 'Password',
  ...
  kernelApiPortInvalid: 'API port must be a number between 1 and 65535',
  kernelApiSecretRequired: 'Password cannot be empty',
  kernelApiSaved: 'API settings saved',
  kernelApiSaveFailed: 'Failed to save API settings',
  ...
  kernelDownloading: 'Downloading kernel',
  kernelDownloadStarting: 'Downloaded, starting kernel',
  kernelDownloadCancelled: 'Kernel download cancelled',
  kernelMissingShort: 'Not installed',
  kernelMissingStartHint: 'The kernel binary has not been downloaded yet — download it below first',
  ...
  applyConfigNoNodes: 'No nodes yet — add one to the pool or update a subscription first',
