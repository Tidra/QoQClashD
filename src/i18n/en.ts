const en = {
  ...
  proxyGroupEditorSelectedLive: 'Switched to “{name}”, applied to the kernel immediately',
  proxyGroupEditorSelectedDraft: '“{name}” saved as the default; takes effect on the next apply',
  ...
  IPInfoAPITip:
    "This API is used for IP geolocation lookups in connection details and zashboard's DNS query feature. IP Check uses its own API selection.",
  general: 'General',
  ...
  mainEntryLocked:
    'The main entry maps to top-level YAML ports, allow-lan, TUN and DNS settings; it cannot be deleted',
  dnsSettings: 'DNS Settings',
  dnsNameserver: 'Nameservers',
  dnsFallback: 'Fallback DNS',
  dnsDefaultNameserver: 'Default Nameserver',
  dnsEnhancedMode: 'Enhanced Mode',
  dnsFakeIpRange: 'Fake-IP Range',
  dnsKernelDefault: 'Kernel default',
  dnsRestartHint: 'DNS is not hot-patchable: save, then apply the config to restart the kernel',
  portHttp: 'HTTP Port',
  ...
  ruleProviderUpdate: 'Download update',
  ruleProviderUpdated: 'Rule set "{name}" updated',
