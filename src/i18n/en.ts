const en = {
  ...
  nodePoolDescription: 'Manage proxy groups, deduplication, and manually inserted nodes.',
  nodePoolName: 'Proxy group name',
  nodePoolDedupe: 'Deduplicate',
  nodePoolEnabled: 'Enabled',
  nodePoolNodes: 'Nodes',
  nodePoolAddNode: 'Add node',
  ...
  nodePoolEmpty: 'No proxy groups yet. Click “Add proxy group” to start managing nodes.',
  nodePoolEmptyDesc: 'Proxy groups let you organize, deduplicate, and test your nodes before generating selector groups.',
