...
const ru: Partial<LANG_MESSAGE> = {
  ...
  panelPasswordSave: 'Войти',
  panelPasswordSaved: 'Пароль панели сохранён',
  goToDashboard: 'Войти в панель',
  ...
  nodePoolDeleteConfirm: 'Удалить этот пул и все его узлы?',
  nodeSaveSuccess: 'Узел сохранён',
  nodeDeleteSuccess: 'Узел удалён',
  nodesDeleteSuccess: 'Удалено узлов: {count}',
  poolSaveSuccess: 'Пул сохранён',
  poolDeleteSuccess: 'Пул удалён',
  latencySortAsc: 'Сначала низкие',
  latencySortDesc: 'Сначала высокие',
  nodeTestAll: 'Тестировать все',
  nodeTestSelected: 'Тестировать выбранные',
  nodeSearchPlaceholder: 'Поиск узлов…',
  defaultGroups: 'Группы по умолчанию',
  defaultGroupsDescription: 'Управляйте группами прокси по регионам по умолчанию.',
  latencyTest: 'Проверить задержку',
  latencyTesting: 'Проверка…',
  latencySort: 'Сортировать по задержке',
  ...
  tunConfig: 'Конфигурация TUN',
  dualModeConfig: 'Двухрежимная конфигурация',
  dualModeForm: 'Форма',
  dualModeYaml: 'YAML',
  dualModeSyncToForm: 'Синхронизировать с формой',
  dualModeSyncToYaml: 'Синхронизировать с YAML',
  ...
  secondaryPathPlaceholder: 'необязательно, напр. /sub',
  ...
  label: 'Метка',
  backendLabelPlaceholder: 'напр. Домашний ПК',
