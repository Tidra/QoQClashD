...
const zh: LANG_MESSAGE = {
  ...
  nodePool: '代理组',
  nodePools: '代理组',
  nodePoolDescription: '管理代理组、去重及手动插入的节点。',
  nodePoolName: '代理组名称',
  nodePoolDedupe: '去除重复',
  nodePoolEnabled: '启用',
  nodePoolNodes: '节点',
  nodePoolAddNode: '新增节点',
  nodePoolRemove: '移除代理组',
  nodePoolAdd: '添加代理组',
  nodePoolEditTitle: '编辑代理组',
  nodePoolAddTitle: '添加代理组',
  nodePoolEmpty: '还没有代理组，点击“添加代理组”开始管理节点。',
  nodePoolEmptyDesc: '代理组帮助你整理、去重并测试节点，然后生成 selector 组。',
  nodeEditTitle: '编辑节点',
  nodeAddTitle: '添加节点',
  nodeName: '名称',
  nodeServer: '服务器',
